...
me_notifications_router = APIRouter()
...
@me_notifications_router.get("", response_model=ResponseModel)
...
@me_notifications_router.patch("/{notification_id}/read", response_model=ResponseModel)
...
@me_notifications_router.patch("/read-all", response_model=ResponseModel)
...
@me_notifications_router.delete("/{notification_id}", response_model=ResponseModel)

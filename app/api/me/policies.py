...
@me_policies_router.post("/list", response_model=ResponseModel)
...
async def upload_policy(
    ...
    """
    Upload a policy. Optionally link to family members by passing
    family_member_ids as a comma-separated string of UUIDs.
    """
    user_id = request.state.user_payload["sub"]
    ...
    # Link family members if provided
...
@me_policies_router.get("/{policy_id}/view")
...
@me_policies_router.get("/{policy_id}/download")
...
@me_policies_router.patch("/{policy_id}", response_model=ResponseModel)

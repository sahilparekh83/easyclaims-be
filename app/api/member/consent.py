...
member_consent_router = APIRouter()


@member_consent_router.get("", response_model=ResponseModel)
...
@member_consent_router.post("", response_model=ResponseModel, status_code=201)

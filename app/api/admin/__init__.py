...
from .whatsapp_templates import admin_whatsapp_templates_router
...
admin_router.include_router(admin_whatsapp_templates_router, prefix="/whatsapp-templates", tags=["Admin - WhatsApp Templates"])

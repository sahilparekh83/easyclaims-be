...
async def trigger_expiry_check(request: Request, _=Depends(require_permission("cron", "edit"))):
...
async def trigger_policy_expiry_check(request: Request, _=Depends(require_permission("cron", "edit"))):
...
async def trigger_policy_status_update(request: Request, _=Depends(require_permission("cron", "edit"))):
